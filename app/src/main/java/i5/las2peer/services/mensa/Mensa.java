...
public class Mensa extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "232", version = "0.0.0",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-232/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response listDishes() {
    ...
    // err
    boolean err_condition = true;
    if(err_condition) {
      JSONObject err = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_INTERNAL_ERROR).entity(err.toJSONString()).build();
    }
    return null;
  }
